...
/* harmony import */ var _Header_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Header.js */ "./src/js/Header.js");
/* harmony import */ var _Sidebar_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Sidebar.js */ "./src/js/Sidebar.js");
...
/* harmony import */ var core_js_modules_es_promise_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core-js/modules/es.promise.js */ "./node_modules/core-js/modules/es.promise.js");
/* harmony import */ var core_js_modules_es_promise_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_promise_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _Sidebar_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Sidebar.js */ "./src/js/Sidebar.js");
  ...
  _createClass(Header, null, [{
    ...
    value: function () {
      var _search = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var pattern, flag, data, options, list, fuse;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 8:
                list = _context.sent;
                console.log(list);
                fuse = new Fuse(list, options); // Change the pattern
                ...
                return _context.abrupt("return", fuse.search(pattern));
...
_defineProperty(Header, "container", document.querySelector('.header'));

_defineProperty(Header, "nearbyBtn", document.querySelector('.header__nearby-btn'));

_defineProperty(Header, "burger", document.querySelector('.fa-bars'));

_defineProperty(Header, "searchText", document.querySelector('header > div > input[type=text]'));
...
/* harmony import */ var _Header_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Header.js */ "./src/js/Header.js");
/* harmony import */ var _Sidebar_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./Sidebar.js */ "./src/js/Sidebar.js");
...
var Map = /*#__PURE__*/function () {
  ...
  _createClass(Map, null, [{
    key: "initMarkerHandler",
    value: // MAP CONTAINER BOX
    ...
    key: "createCircle",
    value: function createCircle(coordinates) {
      var circle = L.circle(coordinates, {
        color: '#2f61b1',
        fillColor: '#4285f4',
        fillOpacity: 0.111,
        radius: 800
      }).addTo(Map.driver).bindPopup('내 지점에서 <b>800미터</b> 이내의 반경입니다.').openPopup();
    }
  }, {
    key: "renderMark",
    value: function renderMark(library) {
      var marker = L.marker([library.XCNTS, library.YDNTS]);
      marker.bindPopup(L.popup({
        ...
        closeOnClick: true,
        className: "popup"
      })).setPopupContent("<b>".concat(library.LBRRY_NAME, "</b><br>\uD074\uB9AD\uD558\uC5EC \uC790\uC138\uD788 \uBCF4\uAE30"));
    ...
    key: "mapSetView",
    value: function mapSetView(lat, lng, zoomScale) {
    ...
    key: "nearbyBtnClick",
    value: function () {
      var _nearbyBtnClick = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(position) {
        var latitude, longitude, res, json;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                latitude = 37.5485156;
                longitude = 126.96857219999998;
                console.time('nearbyBtnClick time');
                _context.next = 6;
                return fetch("https://geocode.xyz/".concat(latitude, ",").concat(longitude, "?geoit=json"));
              ...
              case 9:
                ...
                console.log(json);
                if (json) if (!json.region.includes('Seoul')) {
                  alert("".concat(json.city, "\uC758 \uB370\uC774\uD130\uB294 \uC874\uC7AC\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4. \n\uC624\uC9C1 \uC11C\uC6B8\uC2DC \uB3C4\uC11C\uAD00\uC758 \uB370\uC774\uD130\uB9CC \uAC00\uC9C0\uACE0 \uC788\uC2B5\uB2C8\uB2E4. \uD83D\uDE2D"));
                }
      ...
      function nearbyBtnClick(_x) {
        return _nearbyBtnClick.apply(this, arguments);
      }

      return nearbyBtnClick;
    }()
  }, {
    key: "libAPIFetch",
    value: function () {
      var _libAPIFetch = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var res, row;
      ...
      function libAPIFetch() {
        return _libAPIFetch.apply(this, arguments);
      }
...
_defineProperty(Map, "container", document.querySelector('#map'));

_defineProperty(Map, "driver", L.map('map', {
  tap: false
}).setView([37.5642135, 127.0016985], 11));

_defineProperty(Map, "cluster", L.markerClusterGroup());

_defineProperty(Map, "resizeObserver", new ResizeObserver(function () {
  Map.driver.invalidateSize();
}));

_defineProperty(Map, "cachedLibraries", new globalThis.Map());
...
/* harmony import */ var _Map_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Map.js */ "./src/js/Map.js");
/* harmony import */ var _Header_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./Header.js */ "./src/js/Header.js");
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, null, [{
    ...
    key: "selectedLibraryData",
    value: function selectedLibraryData(e, row) {
      var popup = e.target.closest('.leaflet-popup-content-wrapper');
      if (!popup) return;
      var selectedLibraryName = popup.innerText.split(/\r?\n/)[0];
      console.log(selectedLibraryName);
      var selectedLibraryData = row.find(function (row) {
        return row.LBRRY_NAME === selectedLibraryName;
      });
    ...
    key: "createResultElement",
    value: function createResultElement(data) {
      this.initSearch();
      var searchList = document.querySelector('.map-box__list');

      if (data.length >= 1) {
        searchList.innerHTML = '';
        data.map(function (data) {
          var html = "\n          <li><a href=\"#\">".concat(data.item.LBRRY_NAME, "</a></li>");
...
_defineProperty(Sidebar, "container", document.querySelector('.map-box__sidebar'));
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "seoul-public-library-app:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateseoul_public_library_app"] = (chunkId, moreModules, runtime) => {
