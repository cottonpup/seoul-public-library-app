  ...
  fetch(
    ...
    .then((data) => {
      ...
      mapDiv.addEventListener('click', function (e) {
        ...
        <img class="reading-girl__svg" src="svg/schoolbooks-monochrome.svg" alt="family">
        `;
        ...
        map.setView([selectedLibData.XCNTS, selectedLibData.YDNTS], 15, {
          animate: true,
          pan: {
            duration: 1
          }
